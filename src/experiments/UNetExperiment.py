...
#             print('target.shape: ', target.shape)   #(8, 1, 64, 64)
#             print('prediction.shape: ', prediction.shape)    ##(8, 3, 64, 64) as there are three values 0,1,2 
            break
    ...
    def run_test(self):
        ...
        for i, x in enumerate(self.test_data):
            ...
            if(x["filename"] == 'hippocampus_150.nii.gz'):
                ...
                print(f"{x['filename']} Dice {dc:.4f} and Jaccard: {jc:.4f} . {100*(i+1)/len(self.test_data):.2f}% complete")
                #break
